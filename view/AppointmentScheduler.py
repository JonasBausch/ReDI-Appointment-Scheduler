...
class AppointmentScheduler:
    ...
    def add_client(self):
        ...
        date_of_birth = UiHelper.parse_date(input('Please enter the client\'s date of birth: '))
        existing_conditions = UiHelper.parse_conditions(
            input('Please enter the client\'s existing conditions (comma separated): '))
        languages = UiHelper.parse_languages(input('Please enter the client\'s languages (comma separated): '))
    ...
    def book_appointment(self):
        ...
        selected_client = UiHelper.parse_client(
            input('Please enter the name of the client you want to book an appointment for: '),
